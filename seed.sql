...
(1,	'Default Organization',	'superadmin@example.com', 'super',	'0000-01-01 00:00:00', 1, '206b2dbe-ecc9-490b-b81b-83767288bc5e',	'206b2dbe-ecc9-490b-b81b-83767288bc5e');
...
CREATE TABLE `profiles` (
  ...
  `secret` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
